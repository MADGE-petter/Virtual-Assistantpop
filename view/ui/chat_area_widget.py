...
class ActionConfirmationCardWidget(QFrame):
    ...
    def _setup_ui(self):
        ...
        confirm_btn.setStyleSheet(
            f"QPushButton {{ background-color: {DesignTokens.BG_BASE}; color: #00FFAA; font-weight: 700; border: 1px solid #00CCFF; border-radius: 8px; padding: 6px 14px; }}"
...
class ChatAreaWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        header_bar.setStyleSheet("QFrame { background-color: transparent; border: none; }")
